...
/**
 * Servlet implementation class Rimosso
 */
@WebServlet("/Rimosso")
public class Rimosso extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Query mod=new Query();
		int controllo = mod.getRemovePoi(idpoi_inserito,idpercorso_inserito);
		...
		out.println("<body>");
		if (controllo==1){
		out.println("<h1>P.O.I. RIMOSSO CON SUCCESSO </h1>");
