package percorsiTuristici;
	...
	public class MyConnection {
		...
		static String url = "jdbc:oracle:thin:@//DESKTOP-60DB11V:1521/XE";
		...
		// esegue la query passata come parametro e restituisce il ResultSet con il
		// risultato
		...
		// chiude la connessione al DB e tutti gli oggetti collegati (ResultSet e
		// Statement)
		public void closeConnection() {
			// Chiusura oggetti connessione
			// gli oggetti vanno chiusi correttamente nell'ordine inverso a quello
			// di apertura.
			try {
				rs.close();
				st.close();
